<div align="center">
  ...
  ![Version](https://img.shields.io/badge/version-1.0.77-6366f1?style=for-the-badge)
...
Latest release: [v1.0.77](../../releases/latest)
...
```bash
chmod +x anyDeploy-1.0.77.AppImage
```
Then double-click, or run `./anyDeploy-1.0.77.AppImage`.
