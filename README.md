<div align="center">
  ...
  ![Version](https://img.shields.io/badge/version-1.0.10-6366f1?style=for-the-badge)
...
Latest release: [v1.0.10](../../releases/latest)

| Platform | Download |
|---|---|
| Windows 10+ (64-bit) | [anyDeploy Setup 1.0.10.exe](../../releases/latest/download/anyDeploy.Setup.1.0.10.exe) |
| Linux x64 (Ubuntu 16.04+, Debian 9+, Fedora 25+, any glibc 2.17+ distro) | [anyDeploy-1.0.10.AppImage](../../releases/latest/download/anyDeploy-1.0.10.AppImage) |
